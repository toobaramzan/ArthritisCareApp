...
defaultLabelOptions = {
    ...
    defaultOptions = {
        colors: ['#f0ce36', '#da2323', '#d61c94', '#3498db', '#fd7d3c', '#0ab259',
               '#7f39f3', '#0fd1a6', '#c1e113', '#a7c7ca', '#dbb234', '#0061b3', '#e26a6a', '#1e824c', '#336e7b'],
        ////colors: ['#f6ffc7', '#d4f2e2', '#ebe0c9', '#c3dde9', '#e7fbd9', '#fce6eb',
        ////    '#e8e4cb', '#d8efed', '#fbe6c2', '#e0e3bf', '#d3d6dd', '#e7e0dc', '#e7e3ff', '#fde6e0', '#dff7e5'],
